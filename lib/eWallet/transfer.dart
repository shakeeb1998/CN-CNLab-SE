        ...
        children: <Widget>[
          ...
          Align(child: Padding(
            ...
            children: <Widget>[
              ...
              //pin and Button
              Padding(
                padding: const EdgeInsets.only(left:18.0,top: 34,right: 18),
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: new RaisedButton(onPressed: (){},color:Color.fromRGBO(72, 21, 88, 1) ,child: Padding(
                      ...
                      child: new Text("Transfer",style: TextStyle(color: Colors.white ,fontSize: 18),),
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: new Text("Transfer",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 24),),
                    ),
                  ],
                ),
              ))
